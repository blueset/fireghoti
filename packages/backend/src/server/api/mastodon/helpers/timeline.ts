...
import { Followings, Notes, Notifications, RegistryItems, UserListJoinings } from "@/models/index.js";
...
export class TimelineHelpers {
    ...
    public static async getMarkers(timelines: string[], ctx: MastoContext): Promise<MastodonEntity.Marker> {
    ...
    public static async setMarkers(body: any, ctx: MastoContext): Promise<MastodonEntity.Marker> {
        const result: MastodonEntity.Marker = {};
        for (const key of ["home", "notifications"] as const) {
