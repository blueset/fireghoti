...
export class MiscHelpers {
    public static async getInstance(ctx: MastoContext): Promise<MastodonEntity.Instance> {
        ...
        const res = {
            ...
            short_description:
                meta.description?.substring(0, 50) || "This is an Firefish instance. It doesn’t seem to have a description.",
            description:
                meta.description ||
    ...
    public static async getInstanceV2(ctx: MastoContext): Promise<MastodonEntity.InstanceV2> {
        ...
        const res = {
            ...
            description: meta.description || "This is an Firefish instance. It doesn’t seem to have a description.",
            usage: {
                users: {
