...
import { FirefishVisibility, VisibilityConverter } from "@/server/api/mastodon/converters/visibility.js";
...
export class UserHelpers {
    ...
    public static async getDefaultNoteVisibility(ctx: MastoContext): Promise<FirefishVisibility> {
        const user = ctx.user as ILocalUser;
